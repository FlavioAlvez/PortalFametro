...
public class Persistencia implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent contexto) {
		// TODO Auto-generated method stub
		System.out.println("Iniciando aplica��o...");
		...
		secretarioExemplo.setGenero(Genero.MASCULINO);
		{
			...
			filiacao.setMae("M�e do Secretario Beltrano");
		...
		// Secretario
		{
			...
			endereco.setLogradouro("Avenida Araqu�m Aguiar");
			endereco.setComplemento("Complemento");
			endereco.setNumero(234);
			endereco.setBairro("Prefeito Jos� Walter");
		...
		System.out.println("[SECRETARIO] Colocando banco no contexto da aplica��o...\n");
		...
		professorExemplo.setGenero(Genero.MASCULINO);
		{
			...
			filiacao.setMae("M�e do Professor Beltrano");
		...
		System.out.println("[PROFESSOR] Colocando banco no contexto da aplica��o...\n");
		...
		alunoExemplo.setGenero(Genero.MASCULINO);
		{
			...
			filiacao.setMae("M�e do Aluno Beltrano");
		...
		System.out.println("[ALUNO] Colocando banco no contexto da aplica��o...\n");
		...
		System.out.println("[ENUM] Colocando banco no contexto da aplica��o...\n");
