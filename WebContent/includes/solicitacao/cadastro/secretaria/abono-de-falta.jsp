<form id="demo-form2" data-parsley-validate
	...
	<div class="form-group" id="divDis">
		...
		<div class="col-md-6 col-sm-6 col-xs-6">
			<div class="col-md-6 col-sm-6 col-xs-6">
				<label class="col-md-12 col-sm-12 col-xs-12" for="inicio-atestado">Data
					de início <span class="required"></span>
				</label>
				<div class="col-md-12 col-sm-12 col-xs-12">
					<input type="date" id="inicio-atestado" name="inicio-atestado"
						required="required" class="form-control col-md-7 col-xs-12"
			...
			<div class="col-md-6 col-sm-6 col-xs-6">
				<label class="col-md-12 col-sm-12 col-xs-12" for="inicio-atestado">Data
					de termino <span class="required"></span>
				</label>
				<div class="col-md-12 col-sm-12 col-xs-12">
					<input type="date" id="fim-atestado" name="fim-atestado"
						required="required" class="form-control col-md-7 col-xs-12"
						value="" placeholder="Código">
				</div>
			</div>
